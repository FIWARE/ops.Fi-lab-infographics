...
(function(){
	...
	Chart.MultiTooltip = Chart.Element.extend({
		...
		draw : function(){
			drawRoundedRectangle(this.ctx,this.x,this.y - this.height/2,this.width*2,this.height,this.cornerRadius);
			var ctx = this.ctx;
			ctx.fillStyle = this.fillColor;
			ctx.fill();
			ctx.closePath();
...
// 			console.log(this);//KASIAmod
			...
			helpers.each(this.labels,function(label,index){				
				...
				if(myLabels.length>0)
				  ctx.fillText(label + myLabels[index],this.x + this.xPadding + this.fontSize + 3, this.getLineHeight(index + 1));
				else
